...
local torso = jl.lean:new(
    ...
    0.5,                          --speed,
    "linear",                --interpolation method. Takes string, See just-lean.lua or ease.lua for valid interps. if not using Ease However; "linear" is the only valid interpolation
